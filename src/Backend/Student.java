...
public class Student implements RecordsInterface {
	...
	public void setStudentID(int studentID) {
		if (studentID <= 0) {
			JOptionPane.showMessageDialog(null, "Student ID cannot be negative nor 0", "Input Error",
					JOptionPane.ERROR_MESSAGE);
		} else if (isIDUsed(studentID)) {
			JOptionPane.showMessageDialog(null, "This Student ID already exists! Please choose another one.",
	...
	public String toString() {
		return "ID: " + studentID +
				", Name: " + name + ", Age: " + age + ", Gender: " + gender + ", Department: " + department + ", GPA: "
				+ gpa;
	}
